...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql_update = "UPDATE Contacto SET Nombre = ?, Direccion = ?, Telefono = ?, Correo = ?, Fecha_Na = ? WHERE ID_Contacto = ?";
    $params_update = array($nombre, $direccion, $telefono, $correo, $fecha_na, $id_contacto);
    ...
    if ($stmt_update === false) {
        ...
        $params_update_evento = array($titulo, $fecha_na, $descripcion, $id_evento);
...
<body>
    ...
    <form action="modificar_contacto.php?id=<?php echo $id_contacto; ?>" method="POST">
        ...
        <input type="date" id="fecha_na" name="fecha_na" value="<?php echo $contacto['Fecha_Na']; ?>" required><br><br>
